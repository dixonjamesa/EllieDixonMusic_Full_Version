...
function password_reset($email)
{
	...
	if($res == 1 )
	{
		...
		$message .= "<body><p>Your new password is ".$newpass."</p></body></html>";
		$headers = "MIME-Version: 1.0\r\n";
		$headers .= "Content-type:text/html;charset=UTF-8\r\n";
		$headers .= "From: Ellie Dixon Music <admin@elliedixonmusic.com>\r\n";
		$headers .= "Reply-To: Ellie Dixon Music <admin@elliedixonmusic.com>\r\n";
		$headers .= "Return-Path: Ellie Dixon Music <admin@elliedixonmusic.com>\r\n";
